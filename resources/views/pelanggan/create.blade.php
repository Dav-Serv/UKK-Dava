            ...
            <div class="col-md-6">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="alamat" placeholder="Enter Alamat">
                        @error('name')
                            <small>{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputPassword1" name="tlp" placeholder="Telephone">
                        @error('password')
                            <small>{{ $message }}</small>
                        @enderror
                    </div>
